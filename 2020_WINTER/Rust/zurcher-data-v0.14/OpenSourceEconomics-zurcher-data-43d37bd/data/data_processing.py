...
def data_processing(init_dict):
    ...
    """
    dirname = "D:/Google Drive/2020_WINTER/Rust/zurcher-data-v0.14/OpenSourceEconomics-zurcher-data-43d37bd/data"#os.path.dirname(__file__)
    df_end = pd.DataFrame()
    df_pool = pd.DataFrame()
    #group = init_dict["groups"]#"group_4"
    #if group == "group_4":
...
haha = data_processing({"groups":"group_3","binsize":5000})